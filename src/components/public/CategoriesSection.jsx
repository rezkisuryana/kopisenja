  ...
  return (
    <section id="categories" className="bg-espresso-800 py-20 px-8 md:px-16">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Mobile: compact pills agar muat bersebelahan. Desktop (sm+): ukuran normal */}
        <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
          {/* All */}
          <button onClick={() => onSelect('all')}
            className={cls(
              'flex items-center gap-1.5 sm:gap-2.5 px-3 py-1.5 sm:px-5 sm:py-3 rounded-full border',
            ...
            <span className="text-xs sm:text-base">🍽️</span> Semua
            <span className={cls('text-[10px] sm:text-xs px-1.5 sm:px-2 py-0.5 rounded-full font-medium',
